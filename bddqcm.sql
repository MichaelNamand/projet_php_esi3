...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 07 Avril 2017 à 00:23
...
(1, 'ben', 0, 'Alison', 'Benjamin', 'alison.benjamin@hotmail.fr'),
(5, 'tof', 1234, 'Gand', 'Christophe', 'gand.christophe@free.fr'),
(6, 'lulu', 0, 'Gand', 'Lucile', 'gand.lucile@bbox.fr');
...
--
-- Structure de la table `questionfaite`
--

CREATE TABLE IF NOT EXISTS `questionfaite` (
  `idEtudiant` int(11) NOT NULL,
  `idQuestionnaire` int(11) NOT NULL,
  `idQuestion` int(11) NOT NULL,
  `date` date NOT NULL,
...
--
-- Index pour la table `questionfaite`
--
ALTER TABLE `questionfaite`
  ADD PRIMARY KEY (`idEtudiant`,`idQuestionnaire`,`idQuestion`),
  ADD KEY `idQuestionnaire` (`idQuestionnaire`),
